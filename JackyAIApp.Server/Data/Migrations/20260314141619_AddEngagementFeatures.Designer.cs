...
namespace JackyAIApp.Server.Data.Migrations
{
    ...
    [Migration("20260314141619_AddEngagementFeatures")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JackyAIApp.Server.Data.Models.SQL.CreditTransaction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("JackyAIApp.Server.Data.Models.SQL.DailyChallengeResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DailyChallengeResults");
                });
            ...
            modelBuilder.Entity("JackyAIApp.Server.Data.Models.SQL.UserConnector", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CustomClientId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CustomScopes")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CustomTenantId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("EncryptedAccessToken")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("EncryptedCustomClientSecret")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("JackyAIApp.Server.Data.Models.SQL.UserWord", b =>
                {
                    ...
                    b.Property<double>("ReviewIntervalDays")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("JackyAIApp.Server.Data.Models.SQL.DailyChallengeResult", b =>
                {
                    b.HasOne("JackyAIApp.Server.Data.Models.SQL.User", "User")
                        .WithMany("DailyChallengeResults")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("JackyAIApp.Server.Data.Models.SQL.User", b =>
                {
                    ...
                    b.Navigation("DailyChallengeResults");
